      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center  ">
            ...
            <div className="pt-8 text-center">
              <a href="https://virtuair.vercel.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
            </div>
        ...
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center ">
            ...
            <div className="pt-8 text-center">
              <a href="https://basicportfoliousinghtmlcss.netlify.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
        ...
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center ">
            ...
            <div className="pt-8 text-center">
              <a href="https://burgerpoint.netlify.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
        ...
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center ">
            ...
            <div className="pt-8 text-center">
              <a href="https://skatters.netlify.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
        ...
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center ">
            ...
            <div className="pt-8 text-center">
              <a href="https://tictacto714.netlify.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
        ...
        <div className="transform transition-transform duration-300 hover:scale-105 overflow-hidden shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center  h-[200px]   bg-cover relative">
          ...
          <div className="opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col justify-center items-center ">
            ...
            <div className="pt-8 text-center">
              <a href="https://rock-paper-scissors-714.netlify.app/">
                <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-600 font-bold text-lg">
                  Live
                </button>
              </a>
